...
const CITIES = [
  ...
  },
  {
    ...
    description: "37+ public running tracks across DC, Arlington, Alexandria, Bethesda, Silver Spring, McLean, Falls Church, Bladensburg, and beyond — including DPR's premier Banneker Field.",
    trackCount: 37,
