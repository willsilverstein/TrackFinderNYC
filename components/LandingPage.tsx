...
const CITIES = [
  ...
  },
  {
    ...
    description: "38+ public running tracks across DC, Arlington, Alexandria, Bethesda, Silver Spring, McLean, Falls Church, Bladensburg, and beyond — including DPR's premier Banneker Field.",
    trackCount: 38,
