...
const CITIES = [
  ...
  },
  {
    ...
    description: "28+ public running tracks across DC, Arlington, Alexandria, Bethesda, Silver Spring, McLean, Falls Church, and Annandale — including DPR's premier Banneker Field.",
    trackCount: 28,
